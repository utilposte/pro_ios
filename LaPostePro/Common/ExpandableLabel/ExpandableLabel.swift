...
//  LaPostePro
//
//  Created by Mohamed Helmi Ben Jabeur on 18/06/2018.
...
open class ExpandableLabel: UILabel {
    ...
    fileprivate func textReplaceWithLink(_ lineIndex: LineIndexTuple, text: NSAttributedString, linkName: NSAttributedString) -> NSAttributedString {
        ...
        let truncatedString = lineTextTrimmedNewLines.attributedSubstring(
            from: NSRange(location: 0, length: lengthDifference >= 0 ? lengthDifference : lineTextTrimmedNewLines.string.composedCount))
