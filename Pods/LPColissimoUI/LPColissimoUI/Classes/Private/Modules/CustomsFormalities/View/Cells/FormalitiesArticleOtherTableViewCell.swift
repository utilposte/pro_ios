//
//  FormalitiesArticleOtherTableViewCell.swift
//  LPColissimoUI
//
...
protocol FormalitiesArticleOtherTableViewCellDelegate: class {
...
class FormalitiesArticleOtherTableViewCell: UITableViewCell {
    ...
    weak var delegate: FormalitiesArticleOtherTableViewCellDelegate?
    ...
    func setupCell(otherArticle: OtherArticle, index: Int, check: Bool, weight: Bool, itemsNumber: Int) {
        if itemsNumber > 1 {
        ...
        if let description = otherArticle.description, !description.isEmpty {
        ...
        if !weight {
            ...
            if let weight = otherArticle.weight {
        ...
        if let quantity = otherArticle.quantity {
        ...
        if let unitValue = otherArticle.unitValue {
...
extension FormalitiesArticleOtherTableViewCell: UITextFieldDelegate {
