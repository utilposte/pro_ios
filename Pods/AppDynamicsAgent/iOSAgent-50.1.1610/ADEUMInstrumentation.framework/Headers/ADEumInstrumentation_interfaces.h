 ...
 * Disabling this switch engages the EXPERIMENTAL Beacon File Caching algorithm
 */
 ...
 *
 * Recommended for most applications to leave this option enabled.
 * Disable it in applications that use the interface in unusual or nonstandard ways.
 */
