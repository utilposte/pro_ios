...
#define NOTIFICATION_CART_START_UPDATING    @"NOTIFICATION_CART_START_UPDATING"
#define NOTIFICATION_CART_END_UPDATING      @"NOTIFICATION_CART_END_UPDATING"
...
/**
 * Will planifie alert when the product come back available again
 *
 */
...
- (void)retrieveCartByUserSignUpIdFromCurrentCartsCreateIfNothingPresent:(NSString *)username andExecute:(void (^)(HYBCart *, NSError *))block;
...
- (void)retrieveCurrentCartSignupAndExecute:(void (^)(HYBCart *, NSError *))block;
