...
@property (nonatomic) HYBAddress *paymentAddress;
...
@property (nonatomic) NSNumber *thresholdForFreeShipment;
@property (nonatomic) NSNumber *remainingPriceForFreeShipment;
@property (nonatomic) NSString *estimateShipmentDateLabel;

@property (nonatomic) BOOL hasOnlyEservice;
