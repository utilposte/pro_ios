...
+ (NSDictionary *)JSONKeyPathsByPropertyKey {
    return @{
             ...
             @"thresholdForFreeShipment" : @"thresholdForFreeShipment",
             @"remainingPriceForFreeShipment" : @"remainingPriceForFreeShipment",
             @"estimateShipmentDateLabel" : @"estimateShipmentDateLabel",
             @"hasOnlyEservice" : @"hasOnlyEservice"
             };
}
...
+ (NSValueTransformer *)paymentAddressJSONTransformer {
    return [NSValueTransformer mtl_JSONDictionaryTransformerWithModelClass:[HYBAddress class]];
}
