...
- (NSString*)productAvailabilityWarningURL:(NSString *)productId; //PUT
...
//carts
- (NSString*)userCurrentCartURLForUserId:(NSString*)userId; //GET - POST
...
- (NSString*)renewOrderForUserId:(NSString*)userId code:(NSString *)code; // POST
- (NSString*)userOrderInvoiceURLForUserId:(NSString*)userId andOrderCode:(NSString*)code; //GET
...
//Payment Paypal
- (NSString*)userPaymentModesUrlForUserId:(NSString*)userId andCartId:(NSString*) cartId ; //GET

- (NSString*)userPaymentModeUrlForUserId:(NSString*)userId andCartId:(NSString*) cartId; //PUT
- (NSString*)userPaypalExecuteUrlForUserId:(NSString*)userId andOrderId: (NSString*)orderId; //POST
